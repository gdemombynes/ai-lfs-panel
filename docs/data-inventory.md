...
| HAVE | `ury/ech/{2021..2025}/ECH_MM_YY.csv` (54 monthly bases, 2021-07 to 2025-12, 400 MB), implantation bases, dictionaries, questionnaires; 2021 H2 months unpacked from `Bases_ECH_sem2_2021.rar` | INE Uruguay NADA catalogue (ids 716, 730, 735, 767, 779), open download after accepting INE's terms (research use, no redistribution, cite INE, send publications) | 2026-09-07 | INE terms of use | Uruguay panel 2021Q3-2025Q4 |
| HAVE (resource) | `resources/official/ury_headline.csv` | INE monthly "Actividad, Empleo y Desempleo" pages on gub.uy, scraped by `official.informes_ury` | 2026-09-07 | Public | Uruguay validation |
| HAVE | `bol/ece/pooled/ECE_4T2015_3T2025.zip` (699 MB; Stata, SPSS and CSV members, 2015Q4-2025Q3 pooled, revised weights; CSV unpacked and transcoded to UTF-8 by `fetch.bol.extract_pooled`), `bol/ece/2025Q4/ECE_4T2025.zip` (12 MB) | INE Bolivia, hand-downloaded by the user (ANDA catalogue needs a login; per-quarter entries listed in `fetch/bol.py`) | 2026-09-07 | INE terms (public-use file) | Bolivia panel 2021Q1-2025Q4 |
| HAVE (resource) | `resources/official/bol_headline.csv` | ILOSTAT quarterly participation, employment and unemployment rates for Bolivia (source ECE, 15+), fetched by `official.ilostat_bol` | 2026-09-08 | ILO open data | Bolivia validation |
